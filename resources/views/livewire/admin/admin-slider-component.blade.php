							        ...
							        <table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
											...
											<tr>
												...
												<td class="cell"><img width="150px" src="{{asset('storage/image')}}/{{$s->image}}" alt="{{$s->title}}"></td>

												<td class="cell"><span class="truncate">{{$s->title}}</span></td>
												<td class="cell">{{$s->description}}</td>
												<td class="cell">{{$s->link}}</td>
								
												<td class="cell"><a class="btn-sm app-btn-secondary" href="{{route('admin.slider.edit' , ['slider_id' => $s->id])}}">Düzenle
												
												</a> 
												<a href="#" class="btn-sm app-btn-danger" wire:click.prevent="deleteSlider({{ $s->id }})">
												 Sil </a></td>
											</tr>
						@endforeach
