    ...
    <div class="row">
      <div class="col-md-12">
        <div class="social">
          <ul>
            <li>
              <a class="facebook" href="https://www.instagram.com/efemotokiralama46/">İnstagram <i class="fa fa-instagram"></i>
              </a>
            </li>
            <li>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="recent-post-block">
          ...
          <div class="recent-post">
            ...
            <a href="/galeri" >  <img  src="{{asset('storage')}}/galery/{{$item->image}}" alt="" /> </a>
